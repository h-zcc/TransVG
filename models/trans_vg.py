...
class TransVG(nn.Module):
    def __init__(self, args):
        ...
        num_total = self.num_visu_token + self.num_text_token + 10  # @Trench N_v + N_l + 10  [REG]
        ...
        self.reg_token = nn.Embedding(10, hidden_dim)               # @Trench 10 [REG]token
        ...
        num_classes = 91                                            # @Trench num_classes of 'coco' is 91
    ...
    def forward(self, img_data, text_data):
        ...
        pred_class = self.class_embed(vg_hs)
        out = {'pred_logits': pred_box, 'pred_boxes': pred_class}
        return out
...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        loss_giou = 1 - torch.diag(box_utils.generalized_box_iou(
            box_utils.xywh2xyxy(src_boxes),
            box_utils.xywh2xyxy(target_boxes)))
...
class PostProcess(nn.Module):
    ...
    def forward(self, outputs, target_sizes):
        ...
        boxes = box_utils.xywh2xyxy(out_bbox)
